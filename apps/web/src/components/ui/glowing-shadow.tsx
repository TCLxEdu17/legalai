...
export function GlowingShadow({ children, fullWidth = false }: GlowingShadowProps) {
  return (
    <>
      <style jsx>{`
        @property --hue {
        ...
        /* In full-width mode the content drives the container height */
        .glow-container.full-width .glow-content {
          position: relative;
          width: 100%;
          height: auto;
        ...
        .glow-container.full-width .glow {
          width: 15%;
          height: auto;
          aspect-ratio: 1;
        }
      ...
      <div className={`glow-container${fullWidth ? " full-width" : ""}`}>
        <span className="glow" />
