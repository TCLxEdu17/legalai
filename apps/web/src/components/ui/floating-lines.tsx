...
export function FloatingLines({
  ...
  const getCount = (wave: string) => {
    ...
    const i = enabledWaves.indexOf(wave as 'top' | 'middle' | 'bottom');
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ width: '100%', height: '100%', position: 'absolute', inset: 0, overflow: 'hidden', mixBlendMode: mixBlendMode as React.CSSProperties['mixBlendMode'] }}
    />
  );
}
